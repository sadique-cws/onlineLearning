<x-app-layout>
    ...
    <div class="flex w-full px-24 py-10 gap-10">
        ...
        <div class="w-10/12">
            <div class="px-2 bg-white rounded-lg md:p-4 dark:bg-gray-800" id="stats" role="tabpanel" aria-labelledby="stats-tab">
                <div class="flex items-center justify-between bg-white dark:bg-gray-800 ">
                    <div>
                        <h2 class="text-xl font-bold font-sans text-slate-400">My Statics</h2>
                    </div>
                ...
                <dl class="grid max-w-screen-xl grid-cols-2 gap-8 p-4 mx-auto text-gray-900 sm:grid-cols-3 xl:grid-cols-6 dark:text-white sm:p-8">
                    ...
                    <div class="flex flex-col items-center justify-center">
                        ...
                        <dd class="text-gray-500 dark:text-gray-400">Total Class Attend</dd>
                    </div>
                    <div class="flex flex-col items-center justify-center">
...
<div class="relative overflow-x-auto shadow-md sm:rounded-lg w-full">
    <div class="flex items-center justify-between py-4 bg-white dark:bg-gray-800 p-5">
        <div>
        ...
        <tbody>
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <th scope="row" class="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                    <img class="w-10 h-10 rounded-full" src="{{asset('storage/'.$item->course->image)}}" alt="Jese image">
                    <div class="pl-3">
                        <div class="text-base font-semibold">{{$item->course->title}}</div>
                        <div class="font-normal text-gray-500">{{$item->course->duration}} Weeks</div>
                    </div>
                </th>
                <td class="px-6 py-4">
